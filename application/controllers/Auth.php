...
class Auth extends CI_Controller
{
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($upload_image) {
                ...
                if ($this->upload->do_upload('image')) {
                    ...
                    echo $this->display->upload->display_errors();
                }
            }
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'zallalludin22@gmail.com',
            'smtp_pass' => 'lidqezmrrxqulcgg',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        $this->email->from('zallalludin22@gmail.com', 'Rizal Bagus Pambudi');
